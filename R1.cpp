...
int main()
{
    ...
    if (desired % single == 0)
    {
        cout << "The no. of batteries required to get the desired voltage are " << desired/single << "." << endl;
    }
    if (desired < single)
    {
    ...
    {
        cout << "The no. of batteries to satisfy the required voltage are " << desired/single + 1 << "." << endl;
    }
    system("pause");
    return 0;
}